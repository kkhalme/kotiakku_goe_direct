...
| Leftover 1-phase, high-priority car plugs in and starts taking, lower still surplus | Drop the lower charger. Keep stays off even if go-e reports Complete (leftover stolen / group current starved, not a finished pack). Do not arm 3-phase keep on the lower car |
...
| Leftover moved to another taking charger, this car then Complete | Keep stays off (interrupt). Same-tick Complete is not a finished pack |
