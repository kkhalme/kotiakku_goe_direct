...
| Higher-priority car Idle / not taking, lower taking leftover | Lower gets leftover as first. High still gets leftover MQTT (`frc=2`). No 3 kW steal |
