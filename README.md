...
| Higher-priority car Idle / not taking, lower taking leftover | First **15 s** leftover stays on high (`frc=2`). Then lower gets leftover as first. High still gets leftover MQTT. No 3 kW steal |
