...
def main():
    ...
    def test_psm_and_surplus_eids():
        ...
        assert_eq(const.SPOT_STORAGE_KEY, "kotiakku_goe_direct_spot", "spot storage key")
        assert_eq(const.SPOT_KEEP_DAYS, 8, "spot keep days")
        assert_eq(const.EID_SPOT, "sensor.kotiakku_goe_direct_spot", "spot sensor")
        assert_eq(const.SPOT_SENSOR_UNIQUE_ID, "kotiakku_goe_direct_spot", "spot unique id")
